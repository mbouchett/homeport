...
<body>
	...
	<table class="terms">
		...
		<tr><td>Freight Instructions:<input type="text" name="frgt01" value="<?= $order['order_frgt01'] ?>"> </td><td class="button"><button onclick="return bo(<?= $order_ID ?>);">B/O</button></td></tr>
		<tr><td>Order Instructions:<input type="text" name="frgt02" value="<?= $order['order_frgt02'] ?>"> </td><td class="button"><button onclick="return faxed(<?= $order_ID ?>);">Faxed</button></td></tr>
	...
	<!-- Order Header -->
	<table class="order">
		<tr><td>Purchase Order# <?= $po ?><br>Order Date: <?= $today ?></td><td></td><td style="text-align: right;">Page <?= $page ?> of  <?= $pages ?></td></tr>
		<tr><td colspan="3" height="1" bgcolor="#767676"></td></tr>
		<tr>
			<td>From:</td>
			<td rowspan="8"><?php if($vendor['vendor_hti'] == 1){ ?><img src="../images/hti.jpg" alt="HTI" height="125px" /> <?php } ?></td>
	...
	<table class="terms">
		...
		<tr><td>Freight Instructions: <?= $order['order_frgt01'] ?></td><td></td></tr>
		<tr><td>Order Instructions: <?= $order['order_frgt02'] ?></td><td></td></tr>

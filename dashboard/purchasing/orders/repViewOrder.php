...
<body>
	...
	<table class="terms">
		...
		<tr><td>Freight Instructions: <?= $order['order_frgt01'] ?></td><td class="button"></td></tr>
		<tr><td>Order Instructions: <?= $order['order_frgt02'] ?></td><td class="button"></td></tr>
	...
	<!-- Order Items -->
	<table class="order">
		<tr><td>Order</td><td>Sku</td><td>Description</td><td style="text-align: right;">Cost</td><td style="text-align: right;">Extension</td></tr>

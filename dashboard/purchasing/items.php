...
<div onclick="pop_clear()" id="screen" class="blackout"></div>
	<table>
		<tr>
			<td><a href="printCount.php?vendor_ID=<?= $vendor_ID ?>" >Print Count</a></td>
			<td><a href="orders/enterCount.php?vendor_ID=<?= $vendor_ID ?>" >Place Order</a></td>
			<td><a href="vendorSelect.php?direction=Work" >Change Vendor</a></td>
			<td><a href="vendors/editVendor.php?vendor_ID=<?= $vendor_ID ?>" >Edit Vendor</a></td>
	...
	<table width="800">
		...
		<tr><td colspan="2">Note: <?= $vendor['vendor_note'] ?></td></tr>
    <tr>
...
<?php }
	...
	<input value="Save Edits" type="submit" />
	...
	<table>
		...
		<tr>
			...
			<td class="sku" title="Deleting The Sku Will Delete The Item!"><input class="sku" name="sku[<?= $i ?>]" value="<?= strtoupper($items[$i]['item_sku']) ?>" /></td>
			<td class="desc" title="<?= $hist ?>">
				<input class="desc" name="desc[<?= $i ?>]" value="<?= ucwords(strtolower(stripslashes($items[$i]['item_desc']))) ?>" />
			</td>
			...
			<td class="cost"><input ondblclick="retailCalc(this, <?= $i ?>)" class="cost" name="cost[<?= $i ?>]" value="<?= $items[$i]['item_cost'] ?>" /></td>
			<td class="retail"><input class="retail" name="retail[<?= $i ?>]" value="<?= $items[$i]['item_retail'] ?>" /></td>
			...
			<td title="<?= $items[$i]['item_details'] ?>" class="details" onclick="pop2(<?= $items[$i]['item_ID'] ?>,'<?= addslashes($items[$i]['item_details']) ?>' )">+</td>		
		</tr>
		<?php } ?>
	</table>
	<input value="Save Edits" type="submit" />
	...
	<table>
		<tr>
			...
			<td><a href="orders/enterCount.php?vendor_ID=<?= $vendor_ID ?>" >Place Order</a></td>
			<td><a href="vendorSelect.php?direction=Work" >Change Vendor</a></td>
			<td><a href="vendorEdit.php?vendor_ID=<?= $vendor_ID ?>" >Edit Vendor</a></td>
			<td><a href="../">Exit</a></td>
		</tr>
	</table>

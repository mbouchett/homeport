  ...
  <br><br>
   ...
   <br> <span class="dashtitlegreen"><?php if($message) { ?>
    ...
    <table>
        ...
        <br>
      <a class="dashbut"  onClick="document.processEditResource.submit()"><span class="icontext">&#128190;&nbsp;</span>Save Changes</a><a class="dashbut" href="scheduleDash.php"><span class="icontext">&#128281;&nbsp;</span>Return</a>

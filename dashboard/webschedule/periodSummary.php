...
<head>
  ...
  <br /><br />
    ...
    <tr class="tableheadtext"><td>Employee Name</td><td>Employee Number</td><td>Regular Hours</td><td>OT Hours</td><td>Total Hours</td><td>Vac Pay</td></tr>
    ...
    ?>
        <tr>
            ...
            <td><?= number_format(round($swipeSum[$i]['regHours'],2),2) ?></td>
            <td><?= number_format(round($swipeSum[$i]['ot'],2),2) ?></td>
            <td><?= number_format(round($swipeSum[$i]['regHours'] + $swipeSum[$i]['ot'],2),2) ?></td>
            <td>
                <?= number_format(round($holidayPay,2),2) ?>
            </td>
        </tr>
    <?php } ?>
    <tr class="tableheadtext"><td></td><td>Totals:</td><td><?= $regHourTotal ?></td><td><?= $otHours ?></td><td><?= $regHourTotal + $otHours ?></td><td></td></tr>
    </table>

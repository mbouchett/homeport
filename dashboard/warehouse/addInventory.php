...
<table>
  ...
  <tr>
    ...
    <td><input class="data" id="price" value="<?= $find['item_retail'] ?>" name="price"/></td>
...
if($wi_ID){ ?>
    <table class="result">
      <tr><td>How Many</td><td>Picture</td><td>Description</td><td>Added Where</td></tr>
      <tr>
        <td><?= $addedQty ?></td>
        <td><img height="150" border="0" src="<?=resolve($invItem['wi_pic'])?>"></td>

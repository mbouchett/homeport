...
--
-- Host: localhost:3306
-- Generation Time: Jun 27, 2018 at 10:12 PM
...
(218, 185, 16, 'Grid Back Honey Dining Chair', 4, '89.99'),
(219, 185, 16, 'Honey Drop Leaf Table', 1, '199.00'),
...
--
ALTER TABLE `layItems`
  MODIFY `li_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=239;
COMMIT;
